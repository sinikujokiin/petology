    ...
    <div class="col-12">
        <div class="app-card app-card-settings shadow-sm p-4">
		    ...
		    <div class="app-card-body">
			    <form class="settings-form" method="post" action="<?= base_url('diseases/store') ?>">
				    <div class="mb-3">
					    <label for="code" class="form-label">Kode Penyakit</label>
					    <input type="text" class="form-control" id="code" value="<?= set_value('code') ?>" name="code" required placeholder="P0001">
					...
					<div class="mb-3">
					    ...
					    <textarea class="form-control" id="solution" name="solution" required placeholder="" rows="20"><?= set_value('solution') ?></textarea>
					    <?= isset($error['solution']) ? $error['solution'] : ''  ?>
					</div>
					<div class="mb-3">
					    <label for="reason" class="form-label">Penyebab</label>
					    <textarea class="form-control" id="reason" name="reason" required placeholder="" rows="20"><?= set_value('reason') ?></textarea>
