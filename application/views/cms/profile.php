						...
						<div class="item border-bottom py-3">
							<div class="row justify-content-between align-items-center">
								<div class="col-12">
									...
									<div class="item-data">
										<input type="text" name="username" id="username" value="<?= set_value('username', $user->username) ?>" class="form-control" placeholder="Username">
									</div>
								</div><!--//col-->
							</div><!--//row-->
						</div><!--//item-->
			...
			<div class="app-card-body px-4 w-100">
				...
				<div class="item border-bottom py-3">
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-6">
							<div class="item-label"><strong>Konfirmasi Password</strong></div>
							<div class="item-data">
								<input type="password" name="conf" id="conf" class="form-control" placeholder="**********">
							</div>
						</div><!--//col-->
					</div><!--//row-->
				</div><!--//item-->
